...
function It(t){return null==t}Ot.styles=s`
  ...
  `,t([ht({attribute:!1})],Ei.prototype,"value",void 0),t([ht({type:Boolean})],Ei.prototype,"disabled",void 0),t([ht()],Ei.prototype,"language",void 0),t([pt()],Ei.prototype,"_errors",void 0),Ei=t([ct("shabbat-condition-editor")],Ei);let Ci=class extends at{constructor(){super(...arguments),this.hass=null,this.value={enabled:!1},this.disabled=!1,this.language="en",this._onEnabled=t=>{const e=Boolean(t.detail?.value);this._emit(e?{enabled:!0,within:this.value.within??"01:00:00"}:{enabled:!1})},this._onWithin=t=>{const e=t.detail?.value;var i;this._emit(void 0===e?{enabled:!0}:{enabled:!0,within:(i=e,[i?.hours??0,i?.minutes??0,i?.seconds??0].map(t=>String(t).padStart(2,"0")).join(":"))})}}render(){return H`
    ...
    .help { color: var(--secondary-text-color, #666); font-size: 0.85em; }
  `,t([ht({attribute:!1})],Ci.prototype,"hass",void 0),t([ht({attribute:!1})],Ci.prototype,"value",void 0),t([ht({type:Boolean})],Ci.prototype,"disabled",void 0),t([ht()],Ci.prototype,"language",void 0),Ci=t([ct("shabbat-replay-editor")],Ci);let Si=class extends at{constructor(){super(...arguments),this.hass=null,this.action="",this.data={},this.disabled=!1,this._onChange=t=>{const e=t.detail?.value??{},i={action:"string"==typeof e.action?e.action:""};"object"==typeof e.data&&null!==e.data&&(i.data=e.data),this.dispatchEvent(new CustomEvent("service-changed",{detail:i}))},this._observer=null}render(){return H`
      <div class="wrap">
    ...
    :host { display: block; }
  `,t([ht({attribute:!1})],Si.prototype,"hass",void 0),t([ht()],Si.prototype,"action",void 0),t([ht({attribute:!1})],Si.prototype,"data",void 0),t([ht({type:Boolean})],Si.prototype,"disabled",void 0),Si=t([ct("shabbat-service-editor")],Si);let Oi=class extends at{constructor(){super(...arguments),this.hass=null,this.value={},this.inherited={},this.disabled=!1,this.language="en",this._onChange=t=>{const e=t.detail?.value??{};this.dispatchEvent(new CustomEvent("target-changed",{detail:{value:e}}))}}render(){const t=yt(this.value),e=yt(this.inherited),i=""===t&&""!==e;return H`
      <div class="wrap">
        <ha-selector
          .hass=${this.hass}
          .selector=${{target:{}}}
  ...
  `,t([ht({attribute:!1})],Oi.prototype,"hass",void 0),t([ht({attribute:!1})],Oi.prototype,"value",void 0),t([ht({attribute:!1})],Oi.prototype,"inherited",void 0),t([ht({type:Boolean})],Oi.prototype,"disabled",void 0),t([ht()],Oi.prototype,"language",void 0),Oi=t([ct("shabbat-target-editor")],Oi);const Ii={day:"erev",time:"",action:"",target:{},data:{},condition:[],replay:{enabled:!1},name:null,icon:null,color:null,enabled:!0};let Ti=class extends at{constructor(){super(...arguments),this.hass=null,this.rule=null,this.seed=null,this.day="erev",this.profile=1,this.defaults={},this.canWrite=!1,this.busy=!1,this.error=null,this.language="en",this._form=Ii,this._advanced=!1,this._conditionError=!1,this._seeded=null}willUpdate(){const t=this.rule?`edit:${this.rule.id}`:`new:${this.day}:${this.profile}:${JSON.stringify(this.seed)}`;var e;this._seeded!==t&&(this._seeded=t,this.rule?this._form={day:(e=this.rule).day,time:e.time,action:e.action,target:{...e.target},data:{...e.data},condition:e.condition.map(t=>({...t})),replay:{...e.replay},name:e.name,icon:e.icon,color:e.color,enabled:e.enabled}:this.seed?this._form={...this.seed,day:this.day}:this._form={...Ii,day:this.day},this._advanced=!1)}_patch(t){this._form={...this._form,...t}}_emit(t){this.dispatchEvent(new CustomEvent(t,{detail:{form:this._form,rule:this.rule}}))}_text(t,e){return H`
      <div class="field">
        <label for=${t}>${e}</label>
        <input
          id=${t}
